...
void record() {
    ...
    if (err != paNoError) {
        cerr << "Pa_OpenStream PortAudio error: " << Pa_GetErrorText(err) << endl;
    }

    err = Pa_StartStream(stream);
    if (err != paNoError) {
        cerr << "Pa_StartStream PortAudio error: " << Pa_GetErrorText(err) << endl;
    }
    ...
    if (err != paNoError) {
        cerr << "Pa_StopStream PortAudio error: " << Pa_GetErrorText(err) << endl;
    }

    err = Pa_CloseStream(stream);
    if (err != paNoError) {
        cerr << "Pa_CloseStream PortAudio error: " << Pa_GetErrorText(err) << endl;
    }
